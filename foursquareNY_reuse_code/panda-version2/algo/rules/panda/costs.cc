...
float PANDA_delta_cost(int n_items, int n_trans, int noise, int already_cov) {
    ...
    cout << " | noise: " << noise;
    cout << " | already_cov: " << already_cov << endl;
...
bool isTolerableTrans(int len, int noise){
	cout << "isTolerableTrans: ";
	cout << "noise: " << noise << " len: " << len << " item_tol_ratio: " << item_tol_ratio << endl;
	bool x = (float)noise/(float)len <= item_tol_ratio;
	cout << "result: " << x << endl << endl;
	return (float)noise/(float)len <= item_tol_ratio;
}
bool isTolerableItem(int support, int noise){
	cout << "isTolerableItem: ";
	cout << "noise: " << noise << " support: " << support << " trans_tol_ratio: " << tran_tol_ratio << endl;
	bool x = (float)noise/(float)support <= item_tol_ratio;
	cout << "result: " << x << endl << endl;
